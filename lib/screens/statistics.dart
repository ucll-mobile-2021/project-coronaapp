...
class GetCountry {
  ...
  String getCode() {
    if (code == null || code == "") return "BE.Belgium.+32";
    else return code;
  }
        ...
        body: Column(children: <Widget>[
          CountryListPick(
            ...
            onChanged: (CountryCode code) {
              setState(() {
                String newCode = code.code + "." + code.name + "." + code.dialCode;
                widget.getCountry.setCode(newCode); // todo code in country aanpassen
